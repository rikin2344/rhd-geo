#!/usr/bin/env python3
"""
Generate All Model Pages Script

This script generates HTML pages for all bearing models using the generate_bearing_page.py script.
"""
...
def generate_model_page(model_number):
    ...
    output_file = f"../deployment/specs/miniature-series/{model_number}/index.html"
    ...
    try:
        ...
        cmd = [
            sys.executable, "generate_bearing_page.py",
            json_file,
            template_file,
            output_file
        ]
...
def main():
    """Main execution"""
    print("🚀 GENERATING ALL MODEL PAGES")
    print("=" * 50)
    ...
    if failed_generations:
        ...
        print("📁 Pages are ready in ../deployment/specs/miniature-series/")
